...
export default function AuthPage() {
    ...
    return (
        <div className="flex gap-10 w-11/12 mx-auto justify-around h-screen items-center">
            <Form
                className="w-1/3 h-96 flex flex-col items-start text-black"
            ...
            >
                ...
                <div className="flex items-start w-full gap-4">
                    <Button className="w-1/2 bg-primary text-white" type="submit">Ingresar</Button>
            ...
            <Form className="w-1/3 h-96 flex flex-col items-start text-black">
